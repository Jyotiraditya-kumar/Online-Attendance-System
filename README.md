...
This repository contains code for Attendance system using facial recognition using openCV and python with a tkinter gui interface. 
To test code run train.py file
